...
//void DoMovement();
//void Draw(Model& myModel, ShaderManager shader);
////void DrawNormal(Model& myModel, ShaderManager shader);
//
//void Draw(Model& myModel, ShaderManager shader)
//{
//	GLuint hProg = shader.GetProgam();
//	glUseProgram(hProg);
//
...
////void DrawNormal(Model& myModel, ShaderManager shader)
////{
////	glUseProgram(hNormalProg);
////
////	glm::mat4 proj = camera.GetProjMatrix();
////	glm::mat4 view = camera.GetViewMatrix();
////	glUniformMatrix4fv(glGetUniformLocation(hNormalProg, "projection"), 1, GL_FALSE, glm::value_ptr(proj));
////	glUniformMatrix4fv(glGetUniformLocation(hNormalProg, "view"), 1, GL_FALSE, glm::value_ptr(view));
////
////	glm::mat4 model;
////	glUniformMatrix4fv(glGetUniformLocation(hNormalProg, "model"), 1, GL_FALSE, glm::value_ptr(model));
////
////	myModel.Draw(shader);
////}
//
...
//	}
//
//	ShaderManager shader("shader//geometryV.glsl", "shader//geometryF.glsl");
//
//	ShaderManager shaderNormal("shader//normalV.glsl", "shader//normalF.glsl", "shader//normalG.glsl");
//
